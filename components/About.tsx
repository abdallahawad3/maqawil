      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center justify-between gap-4">
        ...
        <div className="flex items-center justify-center  overflow-hidden">
          <MaskContainer
            ...
            <span className="text-red-500"> الإنشاءات والتشطيب والترميم.</span> نقدم حلولاً متكاملة
            تشمل تشطيبات المباني الداخلية والخارجية، أعمال الديكور، السباكة، الكهرباء، الدهانات،
            الأرضيات، والجبس. بفضل فريقنا من المهندسين والفنيين
